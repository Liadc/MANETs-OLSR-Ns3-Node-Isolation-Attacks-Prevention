...
/// \brief	This header file declares and defines internal state of an IOLSR node.
...
using namespace iolsr;

/// This class encapsulates all data structures needed for maintaining internal state of an IOLSR node.
class IOlsrState
{
  //  friend class IOlsr;
