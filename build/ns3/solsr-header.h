...
#ifndef SOLSR_HEADER_H
#define SOLSR_HEADER_H
...
// 3.3.  Packet Format
//
//    The basic layout of any packet in SOLSR is as follows (omitting IP and
//    UDP headers):
//
//        0                   1                   2                   3
