...
/// \brief	This header file declares and defines internal state of an SOLSR node.

#ifndef SOLSR_STATE_H
#define SOLSR_STATE_H

#include "solsr-repositories.h"

namespace ns3 {

using namespace solsr;

/// This class encapsulates all data structures needed for maintaining internal state of an SOLSR node.
class SOlsrState
{
  //  friend class SOlsr;
...
public:
  ...
  // Added non const topologyset
  TopologySet & GetTopologySet ()
  {
    return m_topologySet;
  }
