...
///		state of an SOLSR node.
///

#include "solsr-state.h"
...
MprSelectorTuple*
SOlsrState::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
SOlsrState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
SOlsrState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
SOlsrState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
SOlsrState::PrintMprSelectorSet () const
{
...
NeighborTuple*
SOlsrState::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
SOlsrState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
SOlsrState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
SOlsrState::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
SOlsrState::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
SOlsrState::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
SOlsrState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
SOlsrState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
SOlsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
SOlsrState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
SOlsrState::FindMprAddress (Ipv4Address const &addr)
{
...
void
SOlsrState::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
SOlsrState::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
SOlsrState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
SOlsrState::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
SOlsrState::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
SOlsrState::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
SOlsrState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
SOlsrState::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
SOlsrState::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
SOlsrState::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
SOlsrState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
SOlsrState::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
SOlsrState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
SOlsrState::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
SOlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
SOlsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
SOlsrState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
SOlsrState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
SOlsrState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
SOlsrState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
SOlsrState::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
SOlsrState::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
SOlsrState::EraseAssociation (const Association &tuple)
{
...
void
SOlsrState::InsertAssociation (const Association &tuple)
{
