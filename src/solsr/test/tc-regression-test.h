...
/**
 * \ingroup solsr
 * \brief Less trivial test of SOLSR Topology Control message generation
 * 
 * This test creates 3 WiFi stations with chain topology and runs SOLSR without any extra traffic. 
