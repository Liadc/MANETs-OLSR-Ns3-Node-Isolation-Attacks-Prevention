...
//
// Simple example of SOLSR routing over some point-to-point links
//
// Network topology
//
//   n0
...
// - DropTail queues 
// - Tracing of queues and packet receptions to file "simple-point-to-point-solsr.tr"
...
NS_LOG_COMPONENT_DEFINE ("SimplePointToPointSOlsrExample");
...
main (int argc, char *argv[])
{
  ...
  // Enable SOLSR
  NS_LOG_INFO ("Enabling SOLSR Routing.");
  SOlsrHelper solsr;
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("simple-point-to-point-solsr.tr"));
  p2p.EnablePcapAll ("simple-point-to-point-solsr");
