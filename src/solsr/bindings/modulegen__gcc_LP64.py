...
def module_init():
    root_module = Module('ns.solsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## solsr-helper.h (module 'solsr'): ns3::SOlsrHelper [class]
    module.add_class('SOlsrHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ## solsr-state.h (module 'solsr'): ns3::SOlsrState [class]
    module.add_class('SOlsrState')
    ...
    module.add_container('std::vector< ns3::solsr::MprSelectorTuple >', 'ns3::solsr::MprSelectorTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::NeighborTuple >', 'ns3::solsr::NeighborTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::TwoHopNeighborTuple >', 'ns3::solsr::TwoHopNeighborTuple', container_type='vector')
    module.add_container('ns3::solsr::MprSet', 'ns3::Ipv4Address', container_type='set')
    module.add_container('std::vector< ns3::solsr::LinkTuple >', 'ns3::solsr::LinkTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::TopologyTuple >', 'ns3::solsr::TopologyTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::IfaceAssocTuple >', 'ns3::solsr::IfaceAssocTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::AssociationTuple >', 'ns3::solsr::AssociationTuple', container_type='vector')
    module.add_container('std::vector< ns3::solsr::Association >', 'ns3::solsr::Association', container_type='vector')
    ...
    ## Register a nested module for the namespace solsr
    
    nested_module = module.add_cpp_namespace('solsr')
    register_types_ns3_solsr(nested_module)
...
def register_types_ns3_solsr(module):
    root_module = module.get_root()
    
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::Association [struct]
    module.add_class('Association')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::solsr::MessageHeader'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::solsr::MessageHeader'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::solsr::MessageHeader::Hello'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::solsr::MessageHeader'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::solsr::MessageHeader::Hna'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::solsr::MessageHeader'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::solsr::MessageHeader'])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::solsr::NeighborTuple'])
    ## solsr-header.h (module 'solsr'): ns3::solsr::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple [struct]
    module.add_class('TwoHopNeighborTuple')
    module.add_container('std::vector< ns3::solsr::MessageHeader::Hello::LinkMessage >', 'ns3::solsr::MessageHeader::Hello::LinkMessage', container_type='vector')
    module.add_container('std::vector< ns3::solsr::MessageHeader::Hna::Association >', 'ns3::solsr::MessageHeader::Hna::Association', container_type='vector')
    module.add_container('std::vector< ns3::solsr::RoutingTableEntry >', 'ns3::solsr::RoutingTableEntry', container_type='vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type='set')
    typehandlers.add_type_alias('std::vector< ns3::solsr::DuplicateTuple, std::allocator< ns3::solsr::DuplicateTuple > >', 'ns3::solsr::DuplicateSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::DuplicateTuple, std::allocator< ns3::solsr::DuplicateTuple > >*', 'ns3::solsr::DuplicateSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::DuplicateTuple, std::allocator< ns3::solsr::DuplicateTuple > >&', 'ns3::solsr::DuplicateSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MprSelectorTuple, std::allocator< ns3::solsr::MprSelectorTuple > >', 'ns3::solsr::MprSelectorSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MprSelectorTuple, std::allocator< ns3::solsr::MprSelectorTuple > >*', 'ns3::solsr::MprSelectorSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MprSelectorTuple, std::allocator< ns3::solsr::MprSelectorTuple > >&', 'ns3::solsr::MprSelectorSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::NeighborTuple, std::allocator< ns3::solsr::NeighborTuple > >', 'ns3::solsr::NeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::NeighborTuple, std::allocator< ns3::solsr::NeighborTuple > >*', 'ns3::solsr::NeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::NeighborTuple, std::allocator< ns3::solsr::NeighborTuple > >&', 'ns3::solsr::NeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::LinkTuple, std::allocator< ns3::solsr::LinkTuple > >', 'ns3::solsr::LinkSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::LinkTuple, std::allocator< ns3::solsr::LinkTuple > >*', 'ns3::solsr::LinkSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::LinkTuple, std::allocator< ns3::solsr::LinkTuple > >&', 'ns3::solsr::LinkSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MessageHeader, std::allocator< ns3::solsr::MessageHeader > >', 'ns3::solsr::MessageList')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MessageHeader, std::allocator< ns3::solsr::MessageHeader > >*', 'ns3::solsr::MessageList*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::MessageHeader, std::allocator< ns3::solsr::MessageHeader > >&', 'ns3::solsr::MessageList&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::AssociationTuple, std::allocator< ns3::solsr::AssociationTuple > >', 'ns3::solsr::AssociationSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::AssociationTuple, std::allocator< ns3::solsr::AssociationTuple > >*', 'ns3::solsr::AssociationSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::AssociationTuple, std::allocator< ns3::solsr::AssociationTuple > >&', 'ns3::solsr::AssociationSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::Association, std::allocator< ns3::solsr::Association > >', 'ns3::solsr::Associations')
    typehandlers.add_type_alias('std::vector< ns3::solsr::Association, std::allocator< ns3::solsr::Association > >*', 'ns3::solsr::Associations*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::Association, std::allocator< ns3::solsr::Association > >&', 'ns3::solsr::Associations&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::IfaceAssocTuple, std::allocator< ns3::solsr::IfaceAssocTuple > >', 'ns3::solsr::IfaceAssocSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::IfaceAssocTuple, std::allocator< ns3::solsr::IfaceAssocTuple > >*', 'ns3::solsr::IfaceAssocSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::IfaceAssocTuple, std::allocator< ns3::solsr::IfaceAssocTuple > >&', 'ns3::solsr::IfaceAssocSet&')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >', 'ns3::solsr::MprSet')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >*', 'ns3::solsr::MprSet*')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >&', 'ns3::solsr::MprSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TwoHopNeighborTuple, std::allocator< ns3::solsr::TwoHopNeighborTuple > >', 'ns3::solsr::TwoHopNeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TwoHopNeighborTuple, std::allocator< ns3::solsr::TwoHopNeighborTuple > >*', 'ns3::solsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TwoHopNeighborTuple, std::allocator< ns3::solsr::TwoHopNeighborTuple > >&', 'ns3::solsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TopologyTuple, std::allocator< ns3::solsr::TopologyTuple > >', 'ns3::solsr::TopologySet')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TopologyTuple, std::allocator< ns3::solsr::TopologyTuple > >*', 'ns3::solsr::TopologySet*')
    typehandlers.add_type_alias('std::vector< ns3::solsr::TopologyTuple, std::allocator< ns3::solsr::TopologyTuple > >&', 'ns3::solsr::TopologySet&')
...
def register_methods(root_module):
    ...
    register_Ns3SOlsrHelper_methods(root_module, root_module['ns3::SOlsrHelper'])
    register_Ns3SOlsrState_methods(root_module, root_module['ns3::SOlsrState'])
    ...
    register_Ns3SOlsrAssociation_methods(root_module, root_module['ns3::solsr::Association'])
    register_Ns3SOlsrAssociationTuple_methods(root_module, root_module['ns3::solsr::AssociationTuple'])
    register_Ns3SOlsrDuplicateTuple_methods(root_module, root_module['ns3::solsr::DuplicateTuple'])
    register_Ns3SOlsrIfaceAssocTuple_methods(root_module, root_module['ns3::solsr::IfaceAssocTuple'])
    register_Ns3SOlsrLinkTuple_methods(root_module, root_module['ns3::solsr::LinkTuple'])
    register_Ns3SOlsrMessageHeader_methods(root_module, root_module['ns3::solsr::MessageHeader'])
    register_Ns3SOlsrMessageHeaderHello_methods(root_module, root_module['ns3::solsr::MessageHeader::Hello'])
    register_Ns3SOlsrMessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::solsr::MessageHeader::Hello::LinkMessage'])
    register_Ns3SOlsrMessageHeaderHna_methods(root_module, root_module['ns3::solsr::MessageHeader::Hna'])
    register_Ns3SOlsrMessageHeaderHnaAssociation_methods(root_module, root_module['ns3::solsr::MessageHeader::Hna::Association'])
    register_Ns3SOlsrMessageHeaderMid_methods(root_module, root_module['ns3::solsr::MessageHeader::Mid'])
    register_Ns3SOlsrMessageHeaderTc_methods(root_module, root_module['ns3::solsr::MessageHeader::Tc'])
    register_Ns3SOlsrMprSelectorTuple_methods(root_module, root_module['ns3::solsr::MprSelectorTuple'])
    register_Ns3SOlsrNeighborTuple_methods(root_module, root_module['ns3::solsr::NeighborTuple'])
    register_Ns3SOlsrPacketHeader_methods(root_module, root_module['ns3::solsr::PacketHeader'])
    register_Ns3SOlsrRoutingProtocol_methods(root_module, root_module['ns3::solsr::RoutingProtocol'])
    register_Ns3SOlsrRoutingTableEntry_methods(root_module, root_module['ns3::solsr::RoutingTableEntry'])
    register_Ns3SOlsrTopologyTuple_methods(root_module, root_module['ns3::solsr::TopologyTuple'])
    register_Ns3SOlsrTwoHopNeighborTuple_methods(root_module, root_module['ns3::solsr::TwoHopNeighborTuple'])
    return
...
def register_Ns3SOlsrHelper_methods(root_module, cls):
    ## solsr-helper.h (module 'solsr'): ns3::SOlsrHelper::SOlsrHelper() [constructor]
    cls.add_constructor([])
    ## solsr-helper.h (module 'solsr'): ns3::SOlsrHelper::SOlsrHelper(ns3::SOlsrHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SOlsrHelper const &', 'arg0')])
    ## solsr-helper.h (module 'solsr'): ns3::SOlsrHelper * ns3::SOlsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::SOlsrHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## solsr-helper.h (module 'solsr'): void ns3::SOlsrHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## solsr-helper.h (module 'solsr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::SOlsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## solsr-helper.h (module 'solsr'): void ns3::SOlsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## solsr-helper.h (module 'solsr'): int64_t ns3::SOlsrHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    return

def register_Ns3SOlsrState_methods(root_module, cls):
    ## solsr-state.h (module 'solsr'): ns3::SOlsrState::SOlsrState(ns3::SOlsrState const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SOlsrState const &', 'arg0')])
    ## solsr-state.h (module 'solsr'): ns3::SOlsrState::SOlsrState() [constructor]
    cls.add_constructor([])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseAssociation(ns3::solsr::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::solsr::Association const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseAssociationTuple(ns3::solsr::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::solsr::AssociationTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseDuplicateTuple(ns3::solsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::solsr::DuplicateTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseIfaceAssocTuple(ns3::solsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::solsr::IfaceAssocTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseLinkTuple(ns3::solsr::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::solsr::LinkTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseMprSelectorTuple(ns3::solsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::solsr::MprSelectorTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseNeighborTuple(ns3::solsr::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::solsr::NeighborTuple const &', 'neighborTuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseTopologyTuple(ns3::solsr::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::solsr::TopologyTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseTwoHopNeighborTuple(ns3::solsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::solsr::TwoHopNeighborTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::AssociationTuple * ns3::SOlsrState::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::solsr::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::DuplicateTuple * ns3::SOlsrState::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::solsr::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::IfaceAssocTuple * ns3::SOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::solsr::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::IfaceAssocTuple const * ns3::SOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::solsr::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::LinkTuple * ns3::SOlsrState::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::solsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## solsr-state.h (module 'solsr'): bool ns3::SOlsrState::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::MprSelectorTuple * ns3::SOlsrState::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::solsr::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## solsr-state.h (module 'solsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::SOlsrState::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::NeighborTuple * ns3::SOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::solsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::NeighborTuple * ns3::SOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::solsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::TopologyTuple * ns3::SOlsrState::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::solsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::LinkTuple * ns3::SOlsrState::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::solsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::NeighborTuple const * ns3::SOlsrState::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::solsr::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::TopologyTuple * ns3::SOlsrState::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::solsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple * ns3::SOlsrState::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::solsr::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::AssociationSet const & ns3::SOlsrState::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::solsr::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::Associations const & ns3::SOlsrState::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::solsr::Associations const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::IfaceAssocSet const & ns3::SOlsrState::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::solsr::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::IfaceAssocSet & ns3::SOlsrState::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::solsr::IfaceAssocSet &', 
                   [])
    ## solsr-state.h (module 'solsr'): ns3::solsr::LinkSet const & ns3::SOlsrState::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::solsr::LinkSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::MprSelectorSet const & ns3::SOlsrState::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::solsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::MprSet ns3::SOlsrState::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::solsr::MprSet', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::NeighborSet const & ns3::SOlsrState::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::solsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::NeighborSet & ns3::SOlsrState::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::solsr::NeighborSet &', 
                   [])
    ## solsr-state.h (module 'solsr'): ns3::solsr::TopologySet const & ns3::SOlsrState::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::solsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::TwoHopNeighborSet const & ns3::SOlsrState::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::solsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): ns3::solsr::TwoHopNeighborSet & ns3::SOlsrState::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::solsr::TwoHopNeighborSet &', 
                   [])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertAssociation(ns3::solsr::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::solsr::Association const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertAssociationTuple(ns3::solsr::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::solsr::AssociationTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertDuplicateTuple(ns3::solsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::solsr::DuplicateTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertIfaceAssocTuple(ns3::solsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::solsr::IfaceAssocTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): ns3::solsr::LinkTuple & ns3::SOlsrState::InsertLinkTuple(ns3::solsr::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::solsr::LinkTuple &', 
                   [param('ns3::solsr::LinkTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertMprSelectorTuple(ns3::solsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::solsr::MprSelectorTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertNeighborTuple(ns3::solsr::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::solsr::NeighborTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertTopologyTuple(ns3::solsr::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::solsr::TopologyTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::InsertTwoHopNeighborTuple(ns3::solsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::solsr::TwoHopNeighborTuple const &', 'tuple')])
    ## solsr-state.h (module 'solsr'): std::string ns3::SOlsrState::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## solsr-state.h (module 'solsr'): void ns3::SOlsrState::SetMprSet(ns3::solsr::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('ns3::solsr::MprSet', 'mprSet')])
    return
...
def register_Ns3SOlsrAssociation_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::Association::Association() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::Association::Association(ns3::solsr::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::Association const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SOlsrAssociationTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::AssociationTuple(ns3::solsr::AssociationTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::AssociationTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SOlsrDuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::DuplicateTuple(ns3::solsr::DuplicateTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::DuplicateTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3SOlsrIfaceAssocTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple::IfaceAssocTuple(ns3::solsr::IfaceAssocTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::IfaceAssocTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3SOlsrLinkTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::LinkTuple(ns3::solsr::LinkTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::LinkTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3SOlsrMessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::MessageHeader(ns3::solsr::MessageHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello & ns3::solsr::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::solsr::MessageHeader::Hello &', 
                   [])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello const & ns3::solsr::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::solsr::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna & ns3::solsr::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::solsr::MessageHeader::Hna &', 
                   [])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna const & ns3::solsr::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::solsr::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint8_t ns3::solsr::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::TypeId ns3::solsr::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): uint16_t ns3::solsr::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::MessageType ns3::solsr::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::solsr::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid & ns3::solsr::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::solsr::MessageHeader::Mid &', 
                   [])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid const & ns3::solsr::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::solsr::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::Ipv4Address ns3::solsr::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc & ns3::solsr::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::solsr::MessageHeader::Tc &', 
                   [])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc const & ns3::solsr::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::solsr::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint8_t ns3::solsr::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): static ns3::TypeId ns3::solsr::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## solsr-header.h (module 'solsr'): ns3::Time ns3::solsr::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetMessageType(ns3::solsr::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::solsr::MessageHeader::MessageType', 'messageType')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3SOlsrMessageHeaderHello_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::Hello(ns3::solsr::MessageHeader::Hello const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Hello const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## solsr-header.h (module 'solsr'): ns3::Time ns3::solsr::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::solsr::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3SOlsrMessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::solsr::MessageHeader::Hello::LinkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3SOlsrMessageHeaderHna_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Hna(ns3::solsr::MessageHeader::Hna const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Hna const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::solsr::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3SOlsrMessageHeaderHnaAssociation_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Association::Association(ns3::solsr::MessageHeader::Hna::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Hna::Association const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3SOlsrMessageHeaderMid_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid::Mid(ns3::solsr::MessageHeader::Mid const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Mid const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3SOlsrMessageHeaderTc_methods(root_module, cls):
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc::Tc(ns3::solsr::MessageHeader::Tc const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MessageHeader::Tc const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## solsr-header.h (module 'solsr'): ns3::solsr::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3SOlsrMprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::MprSelectorTuple::MprSelectorTuple(ns3::solsr::MprSelectorTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::MprSelectorTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SOlsrNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::NeighborTuple(ns3::solsr::NeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::NeighborTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::solsr::NeighborTuple::Status', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3SOlsrPacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## solsr-header.h (module 'solsr'): ns3::solsr::PacketHeader::PacketHeader(ns3::solsr::PacketHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::PacketHeader const &', 'arg0')])
    ## solsr-header.h (module 'solsr'): ns3::solsr::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## solsr-header.h (module 'solsr'): ns3::TypeId ns3::solsr::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): uint16_t ns3::solsr::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint16_t ns3::solsr::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## solsr-header.h (module 'solsr'): uint32_t ns3::solsr::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): static ns3::TypeId ns3::solsr::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## solsr-header.h (module 'solsr'): void ns3::solsr::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## solsr-header.h (module 'solsr'): void ns3::solsr::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3SOlsrRoutingProtocol_methods(root_module, cls):
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingProtocol::RoutingProtocol(ns3::solsr::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::RoutingProtocol const &', 'arg0')])
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## solsr-routing-protocol.h (module 'solsr'): int64_t ns3::solsr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## solsr-routing-protocol.h (module 'solsr'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::solsr::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## solsr-routing-protocol.h (module 'solsr'): std::vector<ns3::solsr::RoutingTableEntry,std::allocator<ns3::solsr::RoutingTableEntry> > ns3::solsr::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::solsr::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## solsr-routing-protocol.h (module 'solsr'): static ns3::TypeId ns3::solsr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): bool ns3::solsr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void,ns3::Ptr<ns3::Ipv4Route>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::Socket::SocketErrno,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): ns3::Ptr<ns3::Ipv4Route> ns3::solsr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## solsr-routing-protocol.h (module 'solsr'): void ns3::solsr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3SOlsrRoutingTableEntry_methods(root_module, cls):
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::RoutingTableEntry(ns3::solsr::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::RoutingTableEntry const &', 'arg0')])
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## solsr-routing-protocol.h (module 'solsr'): ns3::solsr::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3SOlsrTopologyTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::TopologyTuple(ns3::solsr::TopologyTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::TopologyTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3SOlsrTwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::solsr::TwoHopNeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::solsr::TwoHopNeighborTuple const &', 'arg0')])
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## solsr-repositories.h (module 'solsr'): ns3::solsr::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_solsr(module.get_submodule('solsr'), root_module)
    return
...
def register_functions_ns3_solsr(module, root_module):
    ## solsr-header.h (module 'solsr'): extern double ns3::solsr::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## solsr-header.h (module 'solsr'): extern uint8_t ns3::solsr::SecondsToEmf(double seconds) [free function]
