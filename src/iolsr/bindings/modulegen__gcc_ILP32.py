...
def module_init():
    root_module = Module('ns.iolsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## iolsr-helper.h (module 'iolsr'): ns3::IOlsrHelper [class]
    module.add_class('IOlsrHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ## iolsr-state.h (module 'iolsr'): ns3::IOlsrState [class]
    module.add_class('IOlsrState')
    ...
    module.add_container('std::vector< ns3::iolsr::MprSelectorTuple >', 'ns3::iolsr::MprSelectorTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::NeighborTuple >', 'ns3::iolsr::NeighborTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::TwoHopNeighborTuple >', 'ns3::iolsr::TwoHopNeighborTuple', container_type='vector')
    module.add_container('ns3::iolsr::MprSet', 'ns3::Ipv4Address', container_type='set')
    module.add_container('std::vector< ns3::iolsr::LinkTuple >', 'ns3::iolsr::LinkTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::TopologyTuple >', 'ns3::iolsr::TopologyTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::IfaceAssocTuple >', 'ns3::iolsr::IfaceAssocTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::AssociationTuple >', 'ns3::iolsr::AssociationTuple', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::Association >', 'ns3::iolsr::Association', container_type='vector')
    ...
    ## Register a nested module for the namespace iolsr
    
    nested_module = module.add_cpp_namespace('iolsr')
    register_types_ns3_iolsr(nested_module)
...
def register_types_ns3_iolsr(module):
    root_module = module.get_root()
    
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::Association [struct]
    module.add_class('Association')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::iolsr::MessageHeader'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::iolsr::MessageHeader'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::iolsr::MessageHeader::Hello'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::iolsr::MessageHeader'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::iolsr::MessageHeader::Hna'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::iolsr::MessageHeader'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::iolsr::MessageHeader'])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::iolsr::NeighborTuple'])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple [struct]
    module.add_class('TwoHopNeighborTuple')
    module.add_container('std::vector< ns3::iolsr::MessageHeader::Hello::LinkMessage >', 'ns3::iolsr::MessageHeader::Hello::LinkMessage', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::MessageHeader::Hna::Association >', 'ns3::iolsr::MessageHeader::Hna::Association', container_type='vector')
    module.add_container('std::vector< ns3::iolsr::RoutingTableEntry >', 'ns3::iolsr::RoutingTableEntry', container_type='vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type='set')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::DuplicateTuple, std::allocator< ns3::iolsr::DuplicateTuple > >', 'ns3::iolsr::DuplicateSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::DuplicateTuple, std::allocator< ns3::iolsr::DuplicateTuple > >*', 'ns3::iolsr::DuplicateSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::DuplicateTuple, std::allocator< ns3::iolsr::DuplicateTuple > >&', 'ns3::iolsr::DuplicateSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MprSelectorTuple, std::allocator< ns3::iolsr::MprSelectorTuple > >', 'ns3::iolsr::MprSelectorSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MprSelectorTuple, std::allocator< ns3::iolsr::MprSelectorTuple > >*', 'ns3::iolsr::MprSelectorSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MprSelectorTuple, std::allocator< ns3::iolsr::MprSelectorTuple > >&', 'ns3::iolsr::MprSelectorSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::NeighborTuple, std::allocator< ns3::iolsr::NeighborTuple > >', 'ns3::iolsr::NeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::NeighborTuple, std::allocator< ns3::iolsr::NeighborTuple > >*', 'ns3::iolsr::NeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::NeighborTuple, std::allocator< ns3::iolsr::NeighborTuple > >&', 'ns3::iolsr::NeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::LinkTuple, std::allocator< ns3::iolsr::LinkTuple > >', 'ns3::iolsr::LinkSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::LinkTuple, std::allocator< ns3::iolsr::LinkTuple > >*', 'ns3::iolsr::LinkSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::LinkTuple, std::allocator< ns3::iolsr::LinkTuple > >&', 'ns3::iolsr::LinkSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MessageHeader, std::allocator< ns3::iolsr::MessageHeader > >', 'ns3::iolsr::MessageList')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MessageHeader, std::allocator< ns3::iolsr::MessageHeader > >*', 'ns3::iolsr::MessageList*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::MessageHeader, std::allocator< ns3::iolsr::MessageHeader > >&', 'ns3::iolsr::MessageList&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::AssociationTuple, std::allocator< ns3::iolsr::AssociationTuple > >', 'ns3::iolsr::AssociationSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::AssociationTuple, std::allocator< ns3::iolsr::AssociationTuple > >*', 'ns3::iolsr::AssociationSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::AssociationTuple, std::allocator< ns3::iolsr::AssociationTuple > >&', 'ns3::iolsr::AssociationSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::Association, std::allocator< ns3::iolsr::Association > >', 'ns3::iolsr::Associations')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::Association, std::allocator< ns3::iolsr::Association > >*', 'ns3::iolsr::Associations*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::Association, std::allocator< ns3::iolsr::Association > >&', 'ns3::iolsr::Associations&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::IfaceAssocTuple, std::allocator< ns3::iolsr::IfaceAssocTuple > >', 'ns3::iolsr::IfaceAssocSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::IfaceAssocTuple, std::allocator< ns3::iolsr::IfaceAssocTuple > >*', 'ns3::iolsr::IfaceAssocSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::IfaceAssocTuple, std::allocator< ns3::iolsr::IfaceAssocTuple > >&', 'ns3::iolsr::IfaceAssocSet&')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >', 'ns3::iolsr::MprSet')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >*', 'ns3::iolsr::MprSet*')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >&', 'ns3::iolsr::MprSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TwoHopNeighborTuple, std::allocator< ns3::iolsr::TwoHopNeighborTuple > >', 'ns3::iolsr::TwoHopNeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TwoHopNeighborTuple, std::allocator< ns3::iolsr::TwoHopNeighborTuple > >*', 'ns3::iolsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TwoHopNeighborTuple, std::allocator< ns3::iolsr::TwoHopNeighborTuple > >&', 'ns3::iolsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TopologyTuple, std::allocator< ns3::iolsr::TopologyTuple > >', 'ns3::iolsr::TopologySet')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TopologyTuple, std::allocator< ns3::iolsr::TopologyTuple > >*', 'ns3::iolsr::TopologySet*')
    typehandlers.add_type_alias('std::vector< ns3::iolsr::TopologyTuple, std::allocator< ns3::iolsr::TopologyTuple > >&', 'ns3::iolsr::TopologySet&')
...
def register_methods(root_module):
    ...
    register_Ns3IOlsrHelper_methods(root_module, root_module['ns3::IOlsrHelper'])
    register_Ns3IOlsrState_methods(root_module, root_module['ns3::IOlsrState'])
    ...
    register_Ns3IOlsrAssociation_methods(root_module, root_module['ns3::iolsr::Association'])
    register_Ns3IOlsrAssociationTuple_methods(root_module, root_module['ns3::iolsr::AssociationTuple'])
    register_Ns3IOlsrDuplicateTuple_methods(root_module, root_module['ns3::iolsr::DuplicateTuple'])
    register_Ns3IOlsrIfaceAssocTuple_methods(root_module, root_module['ns3::iolsr::IfaceAssocTuple'])
    register_Ns3IOlsrLinkTuple_methods(root_module, root_module['ns3::iolsr::LinkTuple'])
    register_Ns3IOlsrMessageHeader_methods(root_module, root_module['ns3::iolsr::MessageHeader'])
    register_Ns3IOlsrMessageHeaderHello_methods(root_module, root_module['ns3::iolsr::MessageHeader::Hello'])
    register_Ns3IOlsrMessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::iolsr::MessageHeader::Hello::LinkMessage'])
    register_Ns3IOlsrMessageHeaderHna_methods(root_module, root_module['ns3::iolsr::MessageHeader::Hna'])
    register_Ns3IOlsrMessageHeaderHnaAssociation_methods(root_module, root_module['ns3::iolsr::MessageHeader::Hna::Association'])
    register_Ns3IOlsrMessageHeaderMid_methods(root_module, root_module['ns3::iolsr::MessageHeader::Mid'])
    register_Ns3IOlsrMessageHeaderTc_methods(root_module, root_module['ns3::iolsr::MessageHeader::Tc'])
    register_Ns3IOlsrMprSelectorTuple_methods(root_module, root_module['ns3::iolsr::MprSelectorTuple'])
    register_Ns3IOlsrNeighborTuple_methods(root_module, root_module['ns3::iolsr::NeighborTuple'])
    register_Ns3IOlsrPacketHeader_methods(root_module, root_module['ns3::iolsr::PacketHeader'])
    register_Ns3IOlsrRoutingProtocol_methods(root_module, root_module['ns3::iolsr::RoutingProtocol'])
    register_Ns3IOlsrRoutingTableEntry_methods(root_module, root_module['ns3::iolsr::RoutingTableEntry'])
    register_Ns3IOlsrTopologyTuple_methods(root_module, root_module['ns3::iolsr::TopologyTuple'])
    register_Ns3IOlsrTwoHopNeighborTuple_methods(root_module, root_module['ns3::iolsr::TwoHopNeighborTuple'])
    return
...
def register_Ns3IOlsrHelper_methods(root_module, cls):
    ## iolsr-helper.h (module 'iolsr'): ns3::IOlsrHelper::IOlsrHelper() [constructor]
    cls.add_constructor([])
    ## iolsr-helper.h (module 'iolsr'): ns3::IOlsrHelper::IOlsrHelper(ns3::IOlsrHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IOlsrHelper const &', 'arg0')])
    ## iolsr-helper.h (module 'iolsr'): ns3::IOlsrHelper * ns3::IOlsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::IOlsrHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## iolsr-helper.h (module 'iolsr'): void ns3::IOlsrHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## iolsr-helper.h (module 'iolsr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::IOlsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## iolsr-helper.h (module 'iolsr'): void ns3::IOlsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## iolsr-helper.h (module 'iolsr'): int64_t ns3::IOlsrHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    return

def register_Ns3IOlsrState_methods(root_module, cls):
    ## iolsr-state.h (module 'iolsr'): ns3::IOlsrState::IOlsrState(ns3::IOlsrState const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IOlsrState const &', 'arg0')])
    ## iolsr-state.h (module 'iolsr'): ns3::IOlsrState::IOlsrState() [constructor]
    cls.add_constructor([])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseAssociation(ns3::iolsr::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::iolsr::Association const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseAssociationTuple(ns3::iolsr::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::iolsr::AssociationTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseDuplicateTuple(ns3::iolsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::iolsr::DuplicateTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseIfaceAssocTuple(ns3::iolsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::iolsr::IfaceAssocTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseLinkTuple(ns3::iolsr::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::iolsr::LinkTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseMprSelectorTuple(ns3::iolsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::iolsr::MprSelectorTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseNeighborTuple(ns3::iolsr::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::iolsr::NeighborTuple const &', 'neighborTuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseTopologyTuple(ns3::iolsr::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::iolsr::TopologyTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseTwoHopNeighborTuple(ns3::iolsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::iolsr::TwoHopNeighborTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::AssociationTuple * ns3::IOlsrState::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::iolsr::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::DuplicateTuple * ns3::IOlsrState::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::iolsr::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple * ns3::IOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::iolsr::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple const * ns3::IOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::iolsr::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::LinkTuple * ns3::IOlsrState::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::iolsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## iolsr-state.h (module 'iolsr'): bool ns3::IOlsrState::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple * ns3::IOlsrState::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::iolsr::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## iolsr-state.h (module 'iolsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::IOlsrState::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::NeighborTuple * ns3::IOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::iolsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::NeighborTuple * ns3::IOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::iolsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TopologyTuple * ns3::IOlsrState::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::iolsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::LinkTuple * ns3::IOlsrState::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::iolsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::NeighborTuple const * ns3::IOlsrState::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::iolsr::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TopologyTuple * ns3::IOlsrState::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::iolsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple * ns3::IOlsrState::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::iolsr::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::AssociationSet const & ns3::IOlsrState::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::iolsr::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::Associations const & ns3::IOlsrState::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::iolsr::Associations const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::IfaceAssocSet const & ns3::IOlsrState::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::iolsr::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::IfaceAssocSet & ns3::IOlsrState::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::iolsr::IfaceAssocSet &', 
                   [])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::LinkSet const & ns3::IOlsrState::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::iolsr::LinkSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::MprSelectorSet const & ns3::IOlsrState::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::iolsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::MprSet ns3::IOlsrState::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::iolsr::MprSet', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::NeighborSet const & ns3::IOlsrState::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::iolsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::NeighborSet & ns3::IOlsrState::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::iolsr::NeighborSet &', 
                   [])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TopologySet const & ns3::IOlsrState::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::iolsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborSet const & ns3::IOlsrState::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::iolsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborSet & ns3::IOlsrState::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::iolsr::TwoHopNeighborSet &', 
                   [])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertAssociation(ns3::iolsr::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::iolsr::Association const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertAssociationTuple(ns3::iolsr::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::iolsr::AssociationTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertDuplicateTuple(ns3::iolsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::iolsr::DuplicateTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertIfaceAssocTuple(ns3::iolsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::iolsr::IfaceAssocTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): ns3::iolsr::LinkTuple & ns3::IOlsrState::InsertLinkTuple(ns3::iolsr::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::iolsr::LinkTuple &', 
                   [param('ns3::iolsr::LinkTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertMprSelectorTuple(ns3::iolsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::iolsr::MprSelectorTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertNeighborTuple(ns3::iolsr::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::iolsr::NeighborTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertTopologyTuple(ns3::iolsr::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::iolsr::TopologyTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::InsertTwoHopNeighborTuple(ns3::iolsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::iolsr::TwoHopNeighborTuple const &', 'tuple')])
    ## iolsr-state.h (module 'iolsr'): std::string ns3::IOlsrState::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## iolsr-state.h (module 'iolsr'): void ns3::IOlsrState::SetMprSet(ns3::iolsr::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('ns3::iolsr::MprSet', 'mprSet')])
    return
...
def register_Ns3IOlsrAssociation_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::Association::Association() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::Association::Association(ns3::iolsr::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::Association const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IOlsrAssociationTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::AssociationTuple(ns3::iolsr::AssociationTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::AssociationTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IOlsrDuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::DuplicateTuple(ns3::iolsr::DuplicateTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::DuplicateTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3IOlsrIfaceAssocTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple::IfaceAssocTuple(ns3::iolsr::IfaceAssocTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::IfaceAssocTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3IOlsrLinkTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::LinkTuple(ns3::iolsr::LinkTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::LinkTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3IOlsrMessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::MessageHeader(ns3::iolsr::MessageHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello & ns3::iolsr::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::iolsr::MessageHeader::Hello &', 
                   [])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello const & ns3::iolsr::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::iolsr::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna & ns3::iolsr::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::iolsr::MessageHeader::Hna &', 
                   [])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna const & ns3::iolsr::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::iolsr::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint8_t ns3::iolsr::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::TypeId ns3::iolsr::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): uint16_t ns3::iolsr::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::MessageType ns3::iolsr::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::iolsr::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid & ns3::iolsr::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::iolsr::MessageHeader::Mid &', 
                   [])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid const & ns3::iolsr::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::iolsr::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::Ipv4Address ns3::iolsr::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc & ns3::iolsr::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::iolsr::MessageHeader::Tc &', 
                   [])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc const & ns3::iolsr::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::iolsr::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint8_t ns3::iolsr::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): static ns3::TypeId ns3::iolsr::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## iolsr-header.h (module 'iolsr'): ns3::Time ns3::iolsr::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetMessageType(ns3::iolsr::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::iolsr::MessageHeader::MessageType', 'messageType')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3IOlsrMessageHeaderHello_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::Hello(ns3::iolsr::MessageHeader::Hello const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Hello const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## iolsr-header.h (module 'iolsr'): ns3::Time ns3::iolsr::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::iolsr::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3IOlsrMessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::iolsr::MessageHeader::Hello::LinkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IOlsrMessageHeaderHna_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Hna(ns3::iolsr::MessageHeader::Hna const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Hna const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::iolsr::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3IOlsrMessageHeaderHnaAssociation_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Association::Association(ns3::iolsr::MessageHeader::Hna::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Hna::Association const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3IOlsrMessageHeaderMid_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid::Mid(ns3::iolsr::MessageHeader::Mid const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Mid const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IOlsrMessageHeaderTc_methods(root_module, cls):
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc::Tc(ns3::iolsr::MessageHeader::Tc const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MessageHeader::Tc const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IOlsrMprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple::MprSelectorTuple(ns3::iolsr::MprSelectorTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::MprSelectorTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IOlsrNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::NeighborTuple(ns3::iolsr::NeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::NeighborTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::iolsr::NeighborTuple::Status', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3IOlsrPacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::PacketHeader::PacketHeader(ns3::iolsr::PacketHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::PacketHeader const &', 'arg0')])
    ## iolsr-header.h (module 'iolsr'): ns3::iolsr::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): ns3::TypeId ns3::iolsr::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): uint16_t ns3::iolsr::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint16_t ns3::iolsr::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## iolsr-header.h (module 'iolsr'): uint32_t ns3::iolsr::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): static ns3::TypeId ns3::iolsr::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## iolsr-header.h (module 'iolsr'): void ns3::iolsr::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3IOlsrRoutingProtocol_methods(root_module, cls):
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingProtocol::RoutingProtocol(ns3::iolsr::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::RoutingProtocol const &', 'arg0')])
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## iolsr-routing-protocol.h (module 'iolsr'): int64_t ns3::iolsr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## iolsr-routing-protocol.h (module 'iolsr'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::iolsr::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): std::vector<ns3::iolsr::RoutingTableEntry,std::allocator<ns3::iolsr::RoutingTableEntry> > ns3::iolsr::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::iolsr::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): static ns3::TypeId ns3::iolsr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): bool ns3::iolsr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void,ns3::Ptr<ns3::Ipv4Route>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::Socket::SocketErrno,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::Ptr<ns3::Ipv4Route> ns3::iolsr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## iolsr-routing-protocol.h (module 'iolsr'): void ns3::iolsr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3IOlsrRoutingTableEntry_methods(root_module, cls):
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::RoutingTableEntry(ns3::iolsr::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::RoutingTableEntry const &', 'arg0')])
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## iolsr-routing-protocol.h (module 'iolsr'): ns3::iolsr::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IOlsrTopologyTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::TopologyTuple(ns3::iolsr::TopologyTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::TopologyTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3IOlsrTwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::iolsr::TwoHopNeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::iolsr::TwoHopNeighborTuple const &', 'arg0')])
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## iolsr-repositories.h (module 'iolsr'): ns3::iolsr::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_iolsr(module.get_submodule('iolsr'), root_module)
    return
...
def register_functions_ns3_iolsr(module, root_module):
    ## iolsr-header.h (module 'iolsr'): extern double ns3::iolsr::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## iolsr-header.h (module 'iolsr'): extern uint8_t ns3::iolsr::SecondsToEmf(double seconds) [free function]
