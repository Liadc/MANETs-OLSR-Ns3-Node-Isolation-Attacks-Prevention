...
//
// Simple example of IOLSR routing over some point-to-point links
//
// Network topology
//
//   n0
...
// - DropTail queues 
// - Tracing of queues and packet receptions to file "simple-point-to-point-iolsr.tr"
...
NS_LOG_COMPONENT_DEFINE ("SimplePointToPointIOlsrExample");
...
main (int argc, char *argv[])
{
  ...
  // Enable IOLSR
  NS_LOG_INFO ("Enabling IOLSR Routing.");
  IOlsrHelper iolsr;
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("simple-point-to-point-iolsr.tr"));
  p2p.EnablePcapAll ("simple-point-to-point-iolsr");
