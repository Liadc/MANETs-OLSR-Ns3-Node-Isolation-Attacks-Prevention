...
/**
 * \ingroup iolsr
 * \brief Less trivial test of IOLSR Topology Control message generation
 * 
 * This test creates 3 WiFi stations with chain topology and runs IOLSR without any extra traffic. 
