...
class IOlsrMprTestCase : public TestCase {
public:
  IOlsrMprTestCase ();
  ~IOlsrMprTestCase ();
  /// \brief Run test case
...
IOlsrMprTestCase::IOlsrMprTestCase ()
  : TestCase ("Check IOLSR MPR computing mechanism")
{
}
IOlsrMprTestCase::~IOlsrMprTestCase ()
{
...
IOlsrMprTestCase::DoRun ()
{
  ...
  neigbor.willingness = IOLSR_WILL_DEFAULT;
   ...
   */
  neigbor.willingness = IOLSR_WILL_ALWAYS;
   ...
   */
  neigbor.willingness = IOLSR_WILL_NEVER;
...
static class IOlsrProtocolTestSuite : public TestSuite
{
public:
  IOlsrProtocolTestSuite ();
} g_iolsrProtocolTestSuite;

IOlsrProtocolTestSuite::IOlsrProtocolTestSuite()
  : TestSuite ("routing-iolsr", UNIT)
{
  AddTestCase (new IOlsrMprTestCase (), TestCase::QUICK);
}
