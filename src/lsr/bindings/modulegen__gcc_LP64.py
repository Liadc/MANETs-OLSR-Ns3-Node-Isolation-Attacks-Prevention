...
def module_init():
    root_module = Module('ns.lsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## lsr-helper.h (module 'lsr'): ns3::LsrHelper [class]
    module.add_class('LsrHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ## lsr-state.h (module 'lsr'): ns3::LsrState [class]
    module.add_class('LsrState')
    ...
    module.add_container('std::vector< ns3::lsr::MprSelectorTuple >', 'ns3::lsr::MprSelectorTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::NeighborTuple >', 'ns3::lsr::NeighborTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::TwoHopNeighborTuple >', 'ns3::lsr::TwoHopNeighborTuple', container_type='vector')
    module.add_container('ns3::lsr::MprSet', 'ns3::Ipv4Address', container_type='set')
    module.add_container('std::vector< ns3::lsr::LinkTuple >', 'ns3::lsr::LinkTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::TopologyTuple >', 'ns3::lsr::TopologyTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::IfaceAssocTuple >', 'ns3::lsr::IfaceAssocTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::AssociationTuple >', 'ns3::lsr::AssociationTuple', container_type='vector')
    module.add_container('std::vector< ns3::lsr::Association >', 'ns3::lsr::Association', container_type='vector')
    ...
    ## Register a nested module for the namespace lsr
    
    nested_module = module.add_cpp_namespace('lsr')
    register_types_ns3_lsr(nested_module)
...
def register_types_ns3_lsr(module):
    root_module = module.get_root()
    
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::Association [struct]
    module.add_class('Association')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::lsr::MessageHeader'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::lsr::MessageHeader'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::lsr::MessageHeader::Hello'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::lsr::MessageHeader'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::lsr::MessageHeader::Hna'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::lsr::MessageHeader'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::lsr::MessageHeader'])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::lsr::NeighborTuple'])
    ## lsr-header.h (module 'lsr'): ns3::lsr::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple [struct]
    module.add_class('TwoHopNeighborTuple')
    module.add_container('std::vector< ns3::lsr::MessageHeader::Hello::LinkMessage >', 'ns3::lsr::MessageHeader::Hello::LinkMessage', container_type='vector')
    module.add_container('std::vector< ns3::lsr::MessageHeader::Hna::Association >', 'ns3::lsr::MessageHeader::Hna::Association', container_type='vector')
    module.add_container('std::vector< ns3::lsr::RoutingTableEntry >', 'ns3::lsr::RoutingTableEntry', container_type='vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type='set')
    typehandlers.add_type_alias('std::vector< ns3::lsr::DuplicateTuple, std::allocator< ns3::lsr::DuplicateTuple > >', 'ns3::lsr::DuplicateSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::DuplicateTuple, std::allocator< ns3::lsr::DuplicateTuple > >*', 'ns3::lsr::DuplicateSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::DuplicateTuple, std::allocator< ns3::lsr::DuplicateTuple > >&', 'ns3::lsr::DuplicateSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MprSelectorTuple, std::allocator< ns3::lsr::MprSelectorTuple > >', 'ns3::lsr::MprSelectorSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MprSelectorTuple, std::allocator< ns3::lsr::MprSelectorTuple > >*', 'ns3::lsr::MprSelectorSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MprSelectorTuple, std::allocator< ns3::lsr::MprSelectorTuple > >&', 'ns3::lsr::MprSelectorSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::NeighborTuple, std::allocator< ns3::lsr::NeighborTuple > >', 'ns3::lsr::NeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::NeighborTuple, std::allocator< ns3::lsr::NeighborTuple > >*', 'ns3::lsr::NeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::NeighborTuple, std::allocator< ns3::lsr::NeighborTuple > >&', 'ns3::lsr::NeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::LinkTuple, std::allocator< ns3::lsr::LinkTuple > >', 'ns3::lsr::LinkSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::LinkTuple, std::allocator< ns3::lsr::LinkTuple > >*', 'ns3::lsr::LinkSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::LinkTuple, std::allocator< ns3::lsr::LinkTuple > >&', 'ns3::lsr::LinkSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MessageHeader, std::allocator< ns3::lsr::MessageHeader > >', 'ns3::lsr::MessageList')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MessageHeader, std::allocator< ns3::lsr::MessageHeader > >*', 'ns3::lsr::MessageList*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::MessageHeader, std::allocator< ns3::lsr::MessageHeader > >&', 'ns3::lsr::MessageList&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::AssociationTuple, std::allocator< ns3::lsr::AssociationTuple > >', 'ns3::lsr::AssociationSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::AssociationTuple, std::allocator< ns3::lsr::AssociationTuple > >*', 'ns3::lsr::AssociationSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::AssociationTuple, std::allocator< ns3::lsr::AssociationTuple > >&', 'ns3::lsr::AssociationSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::Association, std::allocator< ns3::lsr::Association > >', 'ns3::lsr::Associations')
    typehandlers.add_type_alias('std::vector< ns3::lsr::Association, std::allocator< ns3::lsr::Association > >*', 'ns3::lsr::Associations*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::Association, std::allocator< ns3::lsr::Association > >&', 'ns3::lsr::Associations&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::IfaceAssocTuple, std::allocator< ns3::lsr::IfaceAssocTuple > >', 'ns3::lsr::IfaceAssocSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::IfaceAssocTuple, std::allocator< ns3::lsr::IfaceAssocTuple > >*', 'ns3::lsr::IfaceAssocSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::IfaceAssocTuple, std::allocator< ns3::lsr::IfaceAssocTuple > >&', 'ns3::lsr::IfaceAssocSet&')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >', 'ns3::lsr::MprSet')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >*', 'ns3::lsr::MprSet*')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >&', 'ns3::lsr::MprSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TwoHopNeighborTuple, std::allocator< ns3::lsr::TwoHopNeighborTuple > >', 'ns3::lsr::TwoHopNeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TwoHopNeighborTuple, std::allocator< ns3::lsr::TwoHopNeighborTuple > >*', 'ns3::lsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TwoHopNeighborTuple, std::allocator< ns3::lsr::TwoHopNeighborTuple > >&', 'ns3::lsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TopologyTuple, std::allocator< ns3::lsr::TopologyTuple > >', 'ns3::lsr::TopologySet')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TopologyTuple, std::allocator< ns3::lsr::TopologyTuple > >*', 'ns3::lsr::TopologySet*')
    typehandlers.add_type_alias('std::vector< ns3::lsr::TopologyTuple, std::allocator< ns3::lsr::TopologyTuple > >&', 'ns3::lsr::TopologySet&')
...
def register_methods(root_module):
    ...
    register_Ns3LsrHelper_methods(root_module, root_module['ns3::LsrHelper'])
    register_Ns3LsrState_methods(root_module, root_module['ns3::LsrState'])
    ...
    register_Ns3LsrAssociation_methods(root_module, root_module['ns3::lsr::Association'])
    register_Ns3LsrAssociationTuple_methods(root_module, root_module['ns3::lsr::AssociationTuple'])
    register_Ns3LsrDuplicateTuple_methods(root_module, root_module['ns3::lsr::DuplicateTuple'])
    register_Ns3LsrIfaceAssocTuple_methods(root_module, root_module['ns3::lsr::IfaceAssocTuple'])
    register_Ns3LsrLinkTuple_methods(root_module, root_module['ns3::lsr::LinkTuple'])
    register_Ns3LsrMessageHeader_methods(root_module, root_module['ns3::lsr::MessageHeader'])
    register_Ns3LsrMessageHeaderHello_methods(root_module, root_module['ns3::lsr::MessageHeader::Hello'])
    register_Ns3LsrMessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::lsr::MessageHeader::Hello::LinkMessage'])
    register_Ns3LsrMessageHeaderHna_methods(root_module, root_module['ns3::lsr::MessageHeader::Hna'])
    register_Ns3LsrMessageHeaderHnaAssociation_methods(root_module, root_module['ns3::lsr::MessageHeader::Hna::Association'])
    register_Ns3LsrMessageHeaderMid_methods(root_module, root_module['ns3::lsr::MessageHeader::Mid'])
    register_Ns3LsrMessageHeaderTc_methods(root_module, root_module['ns3::lsr::MessageHeader::Tc'])
    register_Ns3LsrMprSelectorTuple_methods(root_module, root_module['ns3::lsr::MprSelectorTuple'])
    register_Ns3LsrNeighborTuple_methods(root_module, root_module['ns3::lsr::NeighborTuple'])
    register_Ns3LsrPacketHeader_methods(root_module, root_module['ns3::lsr::PacketHeader'])
    register_Ns3LsrRoutingProtocol_methods(root_module, root_module['ns3::lsr::RoutingProtocol'])
    register_Ns3LsrRoutingTableEntry_methods(root_module, root_module['ns3::lsr::RoutingTableEntry'])
    register_Ns3LsrTopologyTuple_methods(root_module, root_module['ns3::lsr::TopologyTuple'])
    register_Ns3LsrTwoHopNeighborTuple_methods(root_module, root_module['ns3::lsr::TwoHopNeighborTuple'])
    return
...
def register_Ns3LsrHelper_methods(root_module, cls):
    ## lsr-helper.h (module 'lsr'): ns3::LsrHelper::LsrHelper() [constructor]
    cls.add_constructor([])
    ## lsr-helper.h (module 'lsr'): ns3::LsrHelper::LsrHelper(ns3::LsrHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::LsrHelper const &', 'arg0')])
    ## lsr-helper.h (module 'lsr'): ns3::LsrHelper * ns3::LsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::LsrHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## lsr-helper.h (module 'lsr'): void ns3::LsrHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## lsr-helper.h (module 'lsr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::LsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## lsr-helper.h (module 'lsr'): void ns3::LsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## lsr-helper.h (module 'lsr'): int64_t ns3::LsrHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    return

def register_Ns3LsrState_methods(root_module, cls):
    ## lsr-state.h (module 'lsr'): ns3::LsrState::LsrState(ns3::LsrState const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::LsrState const &', 'arg0')])
    ## lsr-state.h (module 'lsr'): ns3::LsrState::LsrState() [constructor]
    cls.add_constructor([])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseAssociation(ns3::lsr::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::lsr::Association const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseAssociationTuple(ns3::lsr::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::lsr::AssociationTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseDuplicateTuple(ns3::lsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::lsr::DuplicateTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseIfaceAssocTuple(ns3::lsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::lsr::IfaceAssocTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseLinkTuple(ns3::lsr::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::lsr::LinkTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseMprSelectorTuple(ns3::lsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::lsr::MprSelectorTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseNeighborTuple(ns3::lsr::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::lsr::NeighborTuple const &', 'neighborTuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseTopologyTuple(ns3::lsr::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::lsr::TopologyTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseTwoHopNeighborTuple(ns3::lsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::lsr::TwoHopNeighborTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::AssociationTuple * ns3::LsrState::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::lsr::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::DuplicateTuple * ns3::LsrState::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::lsr::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::IfaceAssocTuple * ns3::LsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::lsr::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::IfaceAssocTuple const * ns3::LsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::lsr::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::LinkTuple * ns3::LsrState::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::lsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## lsr-state.h (module 'lsr'): bool ns3::LsrState::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::MprSelectorTuple * ns3::LsrState::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::lsr::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## lsr-state.h (module 'lsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::LsrState::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::NeighborTuple * ns3::LsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::lsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::NeighborTuple * ns3::LsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::lsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::TopologyTuple * ns3::LsrState::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::lsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::LinkTuple * ns3::LsrState::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::lsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::NeighborTuple const * ns3::LsrState::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::lsr::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::TopologyTuple * ns3::LsrState::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::lsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple * ns3::LsrState::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::lsr::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::AssociationSet const & ns3::LsrState::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::lsr::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::Associations const & ns3::LsrState::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::lsr::Associations const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::IfaceAssocSet const & ns3::LsrState::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::lsr::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::IfaceAssocSet & ns3::LsrState::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::lsr::IfaceAssocSet &', 
                   [])
    ## lsr-state.h (module 'lsr'): ns3::lsr::LinkSet const & ns3::LsrState::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::lsr::LinkSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::MprSelectorSet const & ns3::LsrState::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::lsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::MprSet ns3::LsrState::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::lsr::MprSet', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::NeighborSet const & ns3::LsrState::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::lsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::NeighborSet & ns3::LsrState::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::lsr::NeighborSet &', 
                   [])
    ## lsr-state.h (module 'lsr'): ns3::lsr::TopologySet const & ns3::LsrState::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::lsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::TwoHopNeighborSet const & ns3::LsrState::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::lsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): ns3::lsr::TwoHopNeighborSet & ns3::LsrState::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::lsr::TwoHopNeighborSet &', 
                   [])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertAssociation(ns3::lsr::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::lsr::Association const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertAssociationTuple(ns3::lsr::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::lsr::AssociationTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertDuplicateTuple(ns3::lsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::lsr::DuplicateTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertIfaceAssocTuple(ns3::lsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::lsr::IfaceAssocTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): ns3::lsr::LinkTuple & ns3::LsrState::InsertLinkTuple(ns3::lsr::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::lsr::LinkTuple &', 
                   [param('ns3::lsr::LinkTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertMprSelectorTuple(ns3::lsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::lsr::MprSelectorTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertNeighborTuple(ns3::lsr::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::lsr::NeighborTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertTopologyTuple(ns3::lsr::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::lsr::TopologyTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::InsertTwoHopNeighborTuple(ns3::lsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::lsr::TwoHopNeighborTuple const &', 'tuple')])
    ## lsr-state.h (module 'lsr'): std::string ns3::LsrState::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## lsr-state.h (module 'lsr'): void ns3::LsrState::SetMprSet(ns3::lsr::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('ns3::lsr::MprSet', 'mprSet')])
    return
...
def register_Ns3LsrAssociation_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::Association::Association() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::Association::Association(ns3::lsr::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::Association const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3LsrAssociationTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::AssociationTuple(ns3::lsr::AssociationTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::AssociationTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3LsrDuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::DuplicateTuple(ns3::lsr::DuplicateTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::DuplicateTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3LsrIfaceAssocTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple::IfaceAssocTuple(ns3::lsr::IfaceAssocTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::IfaceAssocTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3LsrLinkTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::LinkTuple(ns3::lsr::LinkTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::LinkTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3LsrMessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::MessageHeader(ns3::lsr::MessageHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello & ns3::lsr::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::lsr::MessageHeader::Hello &', 
                   [])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello const & ns3::lsr::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::lsr::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna & ns3::lsr::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::lsr::MessageHeader::Hna &', 
                   [])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna const & ns3::lsr::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::lsr::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint8_t ns3::lsr::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::TypeId ns3::lsr::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): uint16_t ns3::lsr::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::MessageType ns3::lsr::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::lsr::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid & ns3::lsr::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::lsr::MessageHeader::Mid &', 
                   [])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid const & ns3::lsr::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::lsr::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::Ipv4Address ns3::lsr::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc & ns3::lsr::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::lsr::MessageHeader::Tc &', 
                   [])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc const & ns3::lsr::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::lsr::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint8_t ns3::lsr::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): static ns3::TypeId ns3::lsr::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## lsr-header.h (module 'lsr'): ns3::Time ns3::lsr::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetMessageType(ns3::lsr::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::lsr::MessageHeader::MessageType', 'messageType')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3LsrMessageHeaderHello_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::Hello(ns3::lsr::MessageHeader::Hello const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Hello const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## lsr-header.h (module 'lsr'): ns3::Time ns3::lsr::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::lsr::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3LsrMessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::lsr::MessageHeader::Hello::LinkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3LsrMessageHeaderHna_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Hna(ns3::lsr::MessageHeader::Hna const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Hna const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::lsr::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3LsrMessageHeaderHnaAssociation_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Association::Association(ns3::lsr::MessageHeader::Hna::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Hna::Association const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3LsrMessageHeaderMid_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid::Mid(ns3::lsr::MessageHeader::Mid const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Mid const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3LsrMessageHeaderTc_methods(root_module, cls):
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc::Tc(ns3::lsr::MessageHeader::Tc const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MessageHeader::Tc const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## lsr-header.h (module 'lsr'): ns3::lsr::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3LsrMprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::MprSelectorTuple::MprSelectorTuple(ns3::lsr::MprSelectorTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::MprSelectorTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3LsrNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::NeighborTuple(ns3::lsr::NeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::NeighborTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::lsr::NeighborTuple::Status', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3LsrPacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## lsr-header.h (module 'lsr'): ns3::lsr::PacketHeader::PacketHeader(ns3::lsr::PacketHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::PacketHeader const &', 'arg0')])
    ## lsr-header.h (module 'lsr'): ns3::lsr::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## lsr-header.h (module 'lsr'): ns3::TypeId ns3::lsr::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): uint16_t ns3::lsr::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint16_t ns3::lsr::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## lsr-header.h (module 'lsr'): uint32_t ns3::lsr::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): static ns3::TypeId ns3::lsr::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## lsr-header.h (module 'lsr'): void ns3::lsr::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## lsr-header.h (module 'lsr'): void ns3::lsr::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3LsrRoutingProtocol_methods(root_module, cls):
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingProtocol::RoutingProtocol(ns3::lsr::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::RoutingProtocol const &', 'arg0')])
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## lsr-routing-protocol.h (module 'lsr'): int64_t ns3::lsr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## lsr-routing-protocol.h (module 'lsr'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::lsr::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## lsr-routing-protocol.h (module 'lsr'): std::vector<ns3::lsr::RoutingTableEntry,std::allocator<ns3::lsr::RoutingTableEntry> > ns3::lsr::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::lsr::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## lsr-routing-protocol.h (module 'lsr'): static ns3::TypeId ns3::lsr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): bool ns3::lsr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void,ns3::Ptr<ns3::Ipv4Route>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::Socket::SocketErrno,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): ns3::Ptr<ns3::Ipv4Route> ns3::lsr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## lsr-routing-protocol.h (module 'lsr'): void ns3::lsr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3LsrRoutingTableEntry_methods(root_module, cls):
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::RoutingTableEntry(ns3::lsr::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::RoutingTableEntry const &', 'arg0')])
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## lsr-routing-protocol.h (module 'lsr'): ns3::lsr::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3LsrTopologyTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::TopologyTuple(ns3::lsr::TopologyTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::TopologyTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3LsrTwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::lsr::TwoHopNeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::lsr::TwoHopNeighborTuple const &', 'arg0')])
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## lsr-repositories.h (module 'lsr'): ns3::lsr::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_lsr(module.get_submodule('lsr'), root_module)
    return
...
def register_functions_ns3_lsr(module, root_module):
    ## lsr-header.h (module 'lsr'): extern double ns3::lsr::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## lsr-header.h (module 'lsr'): extern uint8_t ns3::lsr::SecondsToEmf(double seconds) [free function]
