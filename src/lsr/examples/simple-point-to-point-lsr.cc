...
//
// Simple example of LSR routing over some point-to-point links
//
// Network topology
//
//   n0
...
// - DropTail queues 
// - Tracing of queues and packet receptions to file "simple-point-to-point-lsr.tr"
...
NS_LOG_COMPONENT_DEFINE ("SimplePointToPointLsrExample");
...
main (int argc, char *argv[])
{
  ...
  // Enable LSR
  NS_LOG_INFO ("Enabling LSR Routing.");
  LsrHelper lsr;
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("simple-point-to-point-lsr.tr"));
  p2p.EnablePcapAll ("simple-point-to-point-lsr");
