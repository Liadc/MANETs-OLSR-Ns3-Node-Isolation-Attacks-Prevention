...
class LsrMprTestCase : public TestCase {
public:
  LsrMprTestCase ();
  ~LsrMprTestCase ();
  /// \brief Run test case
...
LsrMprTestCase::LsrMprTestCase ()
  : TestCase ("Check LSR MPR computing mechanism")
{
}
LsrMprTestCase::~LsrMprTestCase ()
{
...
LsrMprTestCase::DoRun ()
{
  ...
  neigbor.willingness = LSR_WILL_DEFAULT;
   ...
   */
  neigbor.willingness = LSR_WILL_ALWAYS;
   ...
   */
  neigbor.willingness = LSR_WILL_NEVER;
...
static class LsrProtocolTestSuite : public TestSuite
{
public:
  LsrProtocolTestSuite ();
} g_lsrProtocolTestSuite;

LsrProtocolTestSuite::LsrProtocolTestSuite()
  : TestSuite ("routing-lsr", UNIT)
{
  AddTestCase (new LsrMprTestCase (), TestCase::QUICK);
}
