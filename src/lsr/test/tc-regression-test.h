...
/**
 * \ingroup lsr
 * \brief Less trivial test of LSR Topology Control message generation
 * 
 * This test creates 3 WiFi stations with chain topology and runs LSR without any extra traffic. 
