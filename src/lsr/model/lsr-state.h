...
/// \brief	This header file declares and defines internal state of an LSR node.
...
/// This class encapsulates all data structures needed for maintaining internal state of an LSR node.
class LsrState
{
  //  friend class Lsr;
