...
def module_init():
    root_module = Module('ns.ibolsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## ibolsr-helper.h (module 'ibolsr'): ns3::IBOlsrHelper [class]
    module.add_class('IBOlsrHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ## ibolsr-state.h (module 'ibolsr'): ns3::IBOlsrState [class]
    module.add_class('IBOlsrState')
    ...
    module.add_container('std::vector< ns3::ibolsr::MprSelectorTuple >', 'ns3::ibolsr::MprSelectorTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::NeighborTuple >', 'ns3::ibolsr::NeighborTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::TwoHopNeighborTuple >', 'ns3::ibolsr::TwoHopNeighborTuple', container_type='vector')
    module.add_container('ns3::ibolsr::MprSet', 'ns3::Ipv4Address', container_type='set')
    module.add_container('std::vector< ns3::ibolsr::LinkTuple >', 'ns3::ibolsr::LinkTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::TopologyTuple >', 'ns3::ibolsr::TopologyTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::IfaceAssocTuple >', 'ns3::ibolsr::IfaceAssocTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::AssociationTuple >', 'ns3::ibolsr::AssociationTuple', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::Association >', 'ns3::ibolsr::Association', container_type='vector')
    ...
    ## Register a nested module for the namespace ibolsr
    
    nested_module = module.add_cpp_namespace('ibolsr')
    register_types_ns3_ibolsr(nested_module)
...
def register_types_ns3_ibolsr(module):
    root_module = module.get_root()
    
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::Association [struct]
    module.add_class('Association')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::ibolsr::MessageHeader'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::ibolsr::MessageHeader'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::ibolsr::MessageHeader::Hello'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::ibolsr::MessageHeader'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::ibolsr::MessageHeader::Hna'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::ibolsr::MessageHeader'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::ibolsr::MessageHeader'])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::ibolsr::NeighborTuple'])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple [struct]
    module.add_class('TwoHopNeighborTuple')
    module.add_container('std::vector< ns3::ibolsr::MessageHeader::Hello::LinkMessage >', 'ns3::ibolsr::MessageHeader::Hello::LinkMessage', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::MessageHeader::Hna::Association >', 'ns3::ibolsr::MessageHeader::Hna::Association', container_type='vector')
    module.add_container('std::vector< ns3::ibolsr::RoutingTableEntry >', 'ns3::ibolsr::RoutingTableEntry', container_type='vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type='set')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::DuplicateTuple, std::allocator< ns3::ibolsr::DuplicateTuple > >', 'ns3::ibolsr::DuplicateSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::DuplicateTuple, std::allocator< ns3::ibolsr::DuplicateTuple > >*', 'ns3::ibolsr::DuplicateSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::DuplicateTuple, std::allocator< ns3::ibolsr::DuplicateTuple > >&', 'ns3::ibolsr::DuplicateSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MprSelectorTuple, std::allocator< ns3::ibolsr::MprSelectorTuple > >', 'ns3::ibolsr::MprSelectorSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MprSelectorTuple, std::allocator< ns3::ibolsr::MprSelectorTuple > >*', 'ns3::ibolsr::MprSelectorSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MprSelectorTuple, std::allocator< ns3::ibolsr::MprSelectorTuple > >&', 'ns3::ibolsr::MprSelectorSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::NeighborTuple, std::allocator< ns3::ibolsr::NeighborTuple > >', 'ns3::ibolsr::NeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::NeighborTuple, std::allocator< ns3::ibolsr::NeighborTuple > >*', 'ns3::ibolsr::NeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::NeighborTuple, std::allocator< ns3::ibolsr::NeighborTuple > >&', 'ns3::ibolsr::NeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::LinkTuple, std::allocator< ns3::ibolsr::LinkTuple > >', 'ns3::ibolsr::LinkSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::LinkTuple, std::allocator< ns3::ibolsr::LinkTuple > >*', 'ns3::ibolsr::LinkSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::LinkTuple, std::allocator< ns3::ibolsr::LinkTuple > >&', 'ns3::ibolsr::LinkSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MessageHeader, std::allocator< ns3::ibolsr::MessageHeader > >', 'ns3::ibolsr::MessageList')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MessageHeader, std::allocator< ns3::ibolsr::MessageHeader > >*', 'ns3::ibolsr::MessageList*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::MessageHeader, std::allocator< ns3::ibolsr::MessageHeader > >&', 'ns3::ibolsr::MessageList&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::AssociationTuple, std::allocator< ns3::ibolsr::AssociationTuple > >', 'ns3::ibolsr::AssociationSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::AssociationTuple, std::allocator< ns3::ibolsr::AssociationTuple > >*', 'ns3::ibolsr::AssociationSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::AssociationTuple, std::allocator< ns3::ibolsr::AssociationTuple > >&', 'ns3::ibolsr::AssociationSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::Association, std::allocator< ns3::ibolsr::Association > >', 'ns3::ibolsr::Associations')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::Association, std::allocator< ns3::ibolsr::Association > >*', 'ns3::ibolsr::Associations*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::Association, std::allocator< ns3::ibolsr::Association > >&', 'ns3::ibolsr::Associations&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::IfaceAssocTuple, std::allocator< ns3::ibolsr::IfaceAssocTuple > >', 'ns3::ibolsr::IfaceAssocSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::IfaceAssocTuple, std::allocator< ns3::ibolsr::IfaceAssocTuple > >*', 'ns3::ibolsr::IfaceAssocSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::IfaceAssocTuple, std::allocator< ns3::ibolsr::IfaceAssocTuple > >&', 'ns3::ibolsr::IfaceAssocSet&')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >', 'ns3::ibolsr::MprSet')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >*', 'ns3::ibolsr::MprSet*')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address, std::less< ns3::Ipv4Address >, std::allocator< ns3::Ipv4Address > >&', 'ns3::ibolsr::MprSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TwoHopNeighborTuple, std::allocator< ns3::ibolsr::TwoHopNeighborTuple > >', 'ns3::ibolsr::TwoHopNeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TwoHopNeighborTuple, std::allocator< ns3::ibolsr::TwoHopNeighborTuple > >*', 'ns3::ibolsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TwoHopNeighborTuple, std::allocator< ns3::ibolsr::TwoHopNeighborTuple > >&', 'ns3::ibolsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TopologyTuple, std::allocator< ns3::ibolsr::TopologyTuple > >', 'ns3::ibolsr::TopologySet')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TopologyTuple, std::allocator< ns3::ibolsr::TopologyTuple > >*', 'ns3::ibolsr::TopologySet*')
    typehandlers.add_type_alias('std::vector< ns3::ibolsr::TopologyTuple, std::allocator< ns3::ibolsr::TopologyTuple > >&', 'ns3::ibolsr::TopologySet&')
...
def register_methods(root_module):
    ...
    register_Ns3IBOlsrHelper_methods(root_module, root_module['ns3::IBOlsrHelper'])
    register_Ns3IBOlsrState_methods(root_module, root_module['ns3::IBOlsrState'])
    ...
    register_Ns3IBOlsrAssociation_methods(root_module, root_module['ns3::ibolsr::Association'])
    register_Ns3IBOlsrAssociationTuple_methods(root_module, root_module['ns3::ibolsr::AssociationTuple'])
    register_Ns3IBOlsrDuplicateTuple_methods(root_module, root_module['ns3::ibolsr::DuplicateTuple'])
    register_Ns3IBOlsrIfaceAssocTuple_methods(root_module, root_module['ns3::ibolsr::IfaceAssocTuple'])
    register_Ns3IBOlsrLinkTuple_methods(root_module, root_module['ns3::ibolsr::LinkTuple'])
    register_Ns3IBOlsrMessageHeader_methods(root_module, root_module['ns3::ibolsr::MessageHeader'])
    register_Ns3IBOlsrMessageHeaderHello_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Hello'])
    register_Ns3IBOlsrMessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Hello::LinkMessage'])
    register_Ns3IBOlsrMessageHeaderHna_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Hna'])
    register_Ns3IBOlsrMessageHeaderHnaAssociation_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Hna::Association'])
    register_Ns3IBOlsrMessageHeaderMid_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Mid'])
    register_Ns3IBOlsrMessageHeaderTc_methods(root_module, root_module['ns3::ibolsr::MessageHeader::Tc'])
    register_Ns3IBOlsrMprSelectorTuple_methods(root_module, root_module['ns3::ibolsr::MprSelectorTuple'])
    register_Ns3IBOlsrNeighborTuple_methods(root_module, root_module['ns3::ibolsr::NeighborTuple'])
    register_Ns3IBOlsrPacketHeader_methods(root_module, root_module['ns3::ibolsr::PacketHeader'])
    register_Ns3IBOlsrRoutingProtocol_methods(root_module, root_module['ns3::ibolsr::RoutingProtocol'])
    register_Ns3IBOlsrRoutingTableEntry_methods(root_module, root_module['ns3::ibolsr::RoutingTableEntry'])
    register_Ns3IBOlsrTopologyTuple_methods(root_module, root_module['ns3::ibolsr::TopologyTuple'])
    register_Ns3IBOlsrTwoHopNeighborTuple_methods(root_module, root_module['ns3::ibolsr::TwoHopNeighborTuple'])
    return
...
def register_Ns3IBOlsrHelper_methods(root_module, cls):
    ## ibolsr-helper.h (module 'ibolsr'): ns3::IBOlsrHelper::IBOlsrHelper() [constructor]
    cls.add_constructor([])
    ## ibolsr-helper.h (module 'ibolsr'): ns3::IBOlsrHelper::IBOlsrHelper(ns3::IBOlsrHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IBOlsrHelper const &', 'arg0')])
    ## ibolsr-helper.h (module 'ibolsr'): ns3::IBOlsrHelper * ns3::IBOlsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::IBOlsrHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ibolsr-helper.h (module 'ibolsr'): void ns3::IBOlsrHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## ibolsr-helper.h (module 'ibolsr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::IBOlsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## ibolsr-helper.h (module 'ibolsr'): void ns3::IBOlsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## ibolsr-helper.h (module 'ibolsr'): int64_t ns3::IBOlsrHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    return

def register_Ns3IBOlsrState_methods(root_module, cls):
    ## ibolsr-state.h (module 'ibolsr'): ns3::IBOlsrState::IBOlsrState(ns3::IBOlsrState const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IBOlsrState const &', 'arg0')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::IBOlsrState::IBOlsrState() [constructor]
    cls.add_constructor([])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseAssociation(ns3::ibolsr::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::ibolsr::Association const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseAssociationTuple(ns3::ibolsr::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::ibolsr::AssociationTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseDuplicateTuple(ns3::ibolsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::ibolsr::DuplicateTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseIfaceAssocTuple(ns3::ibolsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::ibolsr::IfaceAssocTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseLinkTuple(ns3::ibolsr::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::ibolsr::LinkTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseMprSelectorTuple(ns3::ibolsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::ibolsr::MprSelectorTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseNeighborTuple(ns3::ibolsr::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::ibolsr::NeighborTuple const &', 'neighborTuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseTopologyTuple(ns3::ibolsr::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::ibolsr::TopologyTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseTwoHopNeighborTuple(ns3::ibolsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::ibolsr::TwoHopNeighborTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple * ns3::IBOlsrState::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::ibolsr::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple * ns3::IBOlsrState::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::ibolsr::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple * ns3::IBOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::ibolsr::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple const * ns3::IBOlsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::ibolsr::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::LinkTuple * ns3::IBOlsrState::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::ibolsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## ibolsr-state.h (module 'ibolsr'): bool ns3::IBOlsrState::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple * ns3::IBOlsrState::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::ibolsr::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## ibolsr-state.h (module 'ibolsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::IBOlsrState::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple * ns3::IBOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::ibolsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple * ns3::IBOlsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::ibolsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple * ns3::IBOlsrState::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::ibolsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::LinkTuple * ns3::IBOlsrState::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::ibolsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple const * ns3::IBOlsrState::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::ibolsr::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple * ns3::IBOlsrState::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::ibolsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple * ns3::IBOlsrState::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::ibolsr::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::AssociationSet const & ns3::IBOlsrState::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::ibolsr::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::Associations const & ns3::IBOlsrState::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::ibolsr::Associations const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocSet const & ns3::IBOlsrState::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::ibolsr::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocSet & ns3::IBOlsrState::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::ibolsr::IfaceAssocSet &', 
                   [])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::LinkSet const & ns3::IBOlsrState::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::ibolsr::LinkSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::MprSelectorSet const & ns3::IBOlsrState::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::ibolsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::MprSet ns3::IBOlsrState::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::ibolsr::MprSet', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::NeighborSet const & ns3::IBOlsrState::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::ibolsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::NeighborSet & ns3::IBOlsrState::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::ibolsr::NeighborSet &', 
                   [])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TopologySet const & ns3::IBOlsrState::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::ibolsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborSet const & ns3::IBOlsrState::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::ibolsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborSet & ns3::IBOlsrState::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::ibolsr::TwoHopNeighborSet &', 
                   [])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertAssociation(ns3::ibolsr::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::ibolsr::Association const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertAssociationTuple(ns3::ibolsr::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::ibolsr::AssociationTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertDuplicateTuple(ns3::ibolsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::ibolsr::DuplicateTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertIfaceAssocTuple(ns3::ibolsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::ibolsr::IfaceAssocTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): ns3::ibolsr::LinkTuple & ns3::IBOlsrState::InsertLinkTuple(ns3::ibolsr::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::ibolsr::LinkTuple &', 
                   [param('ns3::ibolsr::LinkTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertMprSelectorTuple(ns3::ibolsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::ibolsr::MprSelectorTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertNeighborTuple(ns3::ibolsr::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::ibolsr::NeighborTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertTopologyTuple(ns3::ibolsr::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::ibolsr::TopologyTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::InsertTwoHopNeighborTuple(ns3::ibolsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::ibolsr::TwoHopNeighborTuple const &', 'tuple')])
    ## ibolsr-state.h (module 'ibolsr'): std::string ns3::IBOlsrState::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## ibolsr-state.h (module 'ibolsr'): void ns3::IBOlsrState::SetMprSet(ns3::ibolsr::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('ns3::ibolsr::MprSet', 'mprSet')])
    return
...
def register_Ns3IBOlsrAssociation_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::Association::Association() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::Association::Association(ns3::ibolsr::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::Association const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IBOlsrAssociationTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::AssociationTuple(ns3::ibolsr::AssociationTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::AssociationTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IBOlsrDuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::DuplicateTuple(ns3::ibolsr::DuplicateTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::DuplicateTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3IBOlsrIfaceAssocTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple::IfaceAssocTuple(ns3::ibolsr::IfaceAssocTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::IfaceAssocTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3IBOlsrLinkTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::LinkTuple(ns3::ibolsr::LinkTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::LinkTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3IBOlsrMessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::MessageHeader(ns3::ibolsr::MessageHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello & ns3::ibolsr::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::ibolsr::MessageHeader::Hello &', 
                   [])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello const & ns3::ibolsr::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::ibolsr::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna & ns3::ibolsr::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::ibolsr::MessageHeader::Hna &', 
                   [])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna const & ns3::ibolsr::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::ibolsr::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint8_t ns3::ibolsr::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::TypeId ns3::ibolsr::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): uint16_t ns3::ibolsr::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::MessageType ns3::ibolsr::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::ibolsr::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid & ns3::ibolsr::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::ibolsr::MessageHeader::Mid &', 
                   [])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid const & ns3::ibolsr::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::ibolsr::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::Ipv4Address ns3::ibolsr::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc & ns3::ibolsr::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::ibolsr::MessageHeader::Tc &', 
                   [])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc const & ns3::ibolsr::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::ibolsr::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint8_t ns3::ibolsr::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): static ns3::TypeId ns3::ibolsr::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::Time ns3::ibolsr::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetMessageType(ns3::ibolsr::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::ibolsr::MessageHeader::MessageType', 'messageType')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3IBOlsrMessageHeaderHello_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::Hello(ns3::ibolsr::MessageHeader::Hello const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Hello const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::Time ns3::ibolsr::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::ibolsr::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3IBOlsrMessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::ibolsr::MessageHeader::Hello::LinkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IBOlsrMessageHeaderHna_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Hna(ns3::ibolsr::MessageHeader::Hna const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Hna const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::ibolsr::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3IBOlsrMessageHeaderHnaAssociation_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Association::Association(ns3::ibolsr::MessageHeader::Hna::Association const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Hna::Association const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3IBOlsrMessageHeaderMid_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid::Mid(ns3::ibolsr::MessageHeader::Mid const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Mid const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IBOlsrMessageHeaderTc_methods(root_module, cls):
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc::Tc(ns3::ibolsr::MessageHeader::Tc const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MessageHeader::Tc const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3IBOlsrMprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple::MprSelectorTuple(ns3::ibolsr::MprSelectorTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::MprSelectorTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IBOlsrNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::NeighborTuple(ns3::ibolsr::NeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::NeighborTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::ibolsr::NeighborTuple::Status', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3IBOlsrPacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::PacketHeader::PacketHeader(ns3::ibolsr::PacketHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::PacketHeader const &', 'arg0')])
    ## ibolsr-header.h (module 'ibolsr'): ns3::ibolsr::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): ns3::TypeId ns3::ibolsr::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): uint16_t ns3::ibolsr::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint16_t ns3::ibolsr::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## ibolsr-header.h (module 'ibolsr'): uint32_t ns3::ibolsr::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): static ns3::TypeId ns3::ibolsr::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## ibolsr-header.h (module 'ibolsr'): void ns3::ibolsr::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3IBOlsrRoutingProtocol_methods(root_module, cls):
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingProtocol::RoutingProtocol(ns3::ibolsr::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::RoutingProtocol const &', 'arg0')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): int64_t ns3::ibolsr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::ibolsr::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): std::vector<ns3::ibolsr::RoutingTableEntry,std::allocator<ns3::ibolsr::RoutingTableEntry> > ns3::ibolsr::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::ibolsr::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): static ns3::TypeId ns3::ibolsr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): bool ns3::ibolsr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void,ns3::Ptr<ns3::Ipv4Route>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::Socket::SocketErrno,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::Ptr<ns3::Ipv4Route> ns3::ibolsr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): void ns3::ibolsr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3IBOlsrRoutingTableEntry_methods(root_module, cls):
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::RoutingTableEntry(ns3::ibolsr::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::RoutingTableEntry const &', 'arg0')])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## ibolsr-routing-protocol.h (module 'ibolsr'): ns3::ibolsr::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IBOlsrTopologyTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::TopologyTuple(ns3::ibolsr::TopologyTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::TopologyTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3IBOlsrTwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::ibolsr::TwoHopNeighborTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ibolsr::TwoHopNeighborTuple const &', 'arg0')])
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## ibolsr-repositories.h (module 'ibolsr'): ns3::ibolsr::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_ibolsr(module.get_submodule('ibolsr'), root_module)
    return
...
def register_functions_ns3_ibolsr(module, root_module):
    ## ibolsr-header.h (module 'ibolsr'): extern double ns3::ibolsr::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## ibolsr-header.h (module 'ibolsr'): extern uint8_t ns3::ibolsr::SecondsToEmf(double seconds) [free function]
