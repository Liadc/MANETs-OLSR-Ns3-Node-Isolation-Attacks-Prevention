...
/**
 * \ingroup ibolsr
 * \brief Less trivial test of IBOLSR Topology Control message generation
 * 
 * This test creates 3 WiFi stations with chain topology and runs IBOLSR without any extra traffic. 
