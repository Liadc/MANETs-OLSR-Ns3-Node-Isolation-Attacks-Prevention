...
class IBOlsrMprTestCase : public TestCase {
public:
  IBOlsrMprTestCase ();
  ~IBOlsrMprTestCase ();
  /// \brief Run test case
...
IBOlsrMprTestCase::IBOlsrMprTestCase ()
  : TestCase ("Check IBOLSR MPR computing mechanism")
{
}
IBOlsrMprTestCase::~IBOlsrMprTestCase ()
{
...
IBOlsrMprTestCase::DoRun ()
{
  ...
  neigbor.willingness = IBOLSR_WILL_DEFAULT;
   ...
   */
  neigbor.willingness = IBOLSR_WILL_ALWAYS;
   ...
   */
  neigbor.willingness = IBOLSR_WILL_NEVER;
...
static class IBOlsrProtocolTestSuite : public TestSuite
{
public:
  IBOlsrProtocolTestSuite ();
} g_ibolsrProtocolTestSuite;

IBOlsrProtocolTestSuite::IBOlsrProtocolTestSuite()
  : TestSuite ("routing-ibolsr", UNIT)
{
  AddTestCase (new IBOlsrMprTestCase (), TestCase::QUICK);
}
